...
| [乌特加德之巅](bosses/heroic-up/README.md) | Svala / Gortok / Skadi / Ymiron | **仅 ilvl 200 档**：Svala **5/5**（1 死，AT 开战+走到开怪点）、Gortok **5/5**（0 死，宝珠开战）、Ymiron **4/5**（Bane 修复后，隔离）；Skadi **3/6**（鱼叉链已实现 `21fcad00`，完整遭遇；卡在穿过第一波的推进节奏，BACKLOG 14）。 | **3/4 完成（ilvl 200 档）** |
...
| [萨隆矿坑](bosses/heroic-pos/README.md) | Garfrost / Ick / Tyrannus | **仅 ilvl 200 档**：Garfrost **1/3**（不驱散永冻+远程躲岩石后首杀；近战/坦克叠层仍致死，BACKLOG 19）；Ick **5/5**（开怪点移近，真因是治疗锚点拴绳而非载具）；近战躲岩石 0/5 已撤回；Tyrannus **5/6**（隔离跳过隧道，script 模式 + AT 开战，bot 未改）。 | **2/3 稳定；Garfrost 待确认（BACKLOG 19）** |
