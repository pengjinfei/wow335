...
| [萨隆矿坑](bosses/heroic-pos/README.md) | Garfrost / Ick / Tyrannus | **仅 ilvl 200 档**：Garfrost **1/3**（不驱散永冻+远程躲岩石后首杀；近战/坦克叠层仍致死，BACKLOG 19）；Ick **5/5**（开怪点移近，真因是治疗锚点拴绳而非载具）；近战躲岩石 0/5 已撤回；Tyrannus 未建场景（载具乘客 + AT 开战 + Rimefang，见 SURVEY）。 | **未通过（跳过待确认）** |
