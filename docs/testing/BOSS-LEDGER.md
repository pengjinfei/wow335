...
| [冠军的试炼](bosses/heroic-toc5/README.md) | Grand Champions / Eadric / Paletress / Black Knight | **仅 ilvl 200 档，隔离**：Eadric **5/5**；Paletress **5/5**（反射护盾修复 `647c9c66` 后，修前 0/3）；Black Knight **5/5**（副本事件开战，正常规则）；Grand Champions 待确认（BACKLOG 21）。 | **3/4（ilvl 200 档，隔离）** |
