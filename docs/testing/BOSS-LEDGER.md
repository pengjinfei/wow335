...
| [乌特加德之巅](bosses/heroic-up/README.md) | Svala / Gortok / Skadi / Ymiron | **仅 ilvl 200 档**：Svala **5/5**（1 死，AT 开战+走到开怪点；2026-09-27 复跑 run1396–1400 5/5 0 死）、Gortok **5/5**（0 死，宝珠开战）、Ymiron **4/5**（Bane 修复后，隔离）；Skadi **3/6**（鱼叉链已实现 `21fcad00`，完整遭遇；2026-09-27 基线 2/5：坦克被框架带过走廊时不拉怪，后面的人被 4–5 只战士秒，BACKLOG 14 待确认）。 | **3/4 完成（ilvl 200 档）** |
| [灵魂洪炉](bosses/heroic-fos/README.md) | Bronjahm / Devourer of Souls | **仅 ilvl 200 档**：Bronjahm **4/5**（Corrupt Soul 目标离 boss 25 码 + DPS 直接打碎片）、Devourer **3/5**（哀嚎之魂期间非坦克站 boss 背后），playerbots `fdd4ff99`。 | **基本稳定（ilvl 200 档）** |
| [萨隆矿坑](bosses/heroic-pos/README.md) | Garfrost / Ick / Tyrannus | **仅 ilvl 200 档**：Garfrost **1/3**（不驱散永冻+远程躲岩石后首杀；近战/坦克叠层仍致死；2026-09-27 基线 0/5，AC 脚本近战距离内永冻必中，BACKLOG 19 待确认）；Ick **5/5**（开怪点移近，真因是治疗锚点拴绳而非载具）；近战躲岩石 0/5 已撤回；Tyrannus **5/6**（隔离跳过隧道，script 模式 + AT 开战，bot 未改）。 | **2/3 稳定；Garfrost 待确认（BACKLOG 19）** |
| [紫罗兰监狱](bosses/heroic-vh/README.md) | Moragg / Erekem / Ichoron / Lavanthor / Xevozz / Zuramat / Cyanigosa | **仅 ilvl 200 档，隔离（夹具放出牢房 boss）**：Ichoron / Lavanthor / Moragg / Erekem / Zuramat 各 **5/5**（0 死），Xevozz **4/5**；Cyanigosa **6/6**（房间中央召出）。 | **7/7 完成（ilvl 200 档，隔离）** |
...
| [魔环](bosses/heroic-oculus/README.md) | Drakos / Varos / Urom / Eregos | **仅 ilvl 200 档**：Drakos **5/5**（完整）；Varos **5/5**（地面隔离，非龙战）；Urom **5/5**（内环本体战隔离）；Eregos **2/5**（龙战完整遭遇；骑龙躲 Planar Anomaly `d1181635`，改前 0/14，剩余团灭在 20–30%）。 | **4/4 有击杀（ilvl 200 档；Eregos 不稳定）** |
