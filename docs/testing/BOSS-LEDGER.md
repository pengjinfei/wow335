...
| heroic-uk-ingvar，五人 heroic5-disc-v1 | run116/a1 112.716s（2 死）与 run130/a1 115.014s（3 死）击杀；均覆盖 P1→复活→P2 | UK 绕背/远程/暗影斧策略修复，2s 坦克仇恨窗口与重启实例清理均实测 | 至少一次独立冷启动回归，评估伤亡与稳定率 |
