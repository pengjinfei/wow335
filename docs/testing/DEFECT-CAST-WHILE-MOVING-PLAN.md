...
## 13. 回归（2026-09-13 傍晚，run 474–476）

两处共享层改动（施法让路、同层守卫）在三个旧 boss 各 3 场：凯利丝塔萨隔离 2/3（1 场 1% 团灭）、阿诺姆鲁斯 3/3、斯卡瓦尔德 3/3，
击杀全部零死亡且时长在基线区间。`floor-guard` 0 次；`cast-vs-move` 21 次 = 3 次 refuse（`rear flank`）+ 18 次 yield（斯卡瓦尔德，全部是 `reach spell` 途中停下施法：
牧师魔杖 9、法师灼烧 7、萨满闪电箭 1、法师造法力宝石 1）。结论：两处改动在已通关内容上无可见回归，让路路径按设计工作。
