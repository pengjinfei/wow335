...
| 二进制/配置边界 | my-mac 构建：core `69f271af6` / playerbots `aabfd58f` / raidtest `61f345d`；场景模板 raidtest `mymac/dev` `ddb181b`（未推送） |
...
| 阿曼尼塔 30258（仅英雄） | `heroic-ak-amanitar-h5g` | 洞穴 + 3 只洞穴兽前置 | v1 run100016 作废（清怪路线擦过 boss）；v2 run100019 **timeout，boss 31%、0 死** | 量 Mini 覆盖率；疑似 playerbots 策略空白 |
| 传令官沃拉兹 29311 | `heroic-ak-volazj-h5g` | 房间 + 走廊两只巡逻被遗忘者前置 | 冒烟 run100017 **kill、0 死**（187.8 秒；两次疯狂均出现，扭曲幻象造成 3.7 万伤害） | 跑 10 场基线 |
