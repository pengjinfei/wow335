...
- 场景：map 576 / boss 26794 / 英雄 / 5 人 / **不声明前置怪，但遭遇战范围没有改小** /
  拉怪点 **(275.0, -215.0, -9.00)**（boss 东北 14.5 码，位移导航探针验证在网格上且连通）。
- 角色 guid 796–800（本副本四个 boss 共用）。

### 口径说明：这不是「删小怪的隔离形态」

按 [START-HERE 的「场景范围与结论口径」](../../../START-HERE.md)，删掉遭遇战本该清的小怪
会把场景改成隔离形态、结论必须降级。**本场景不属于那种情况**：`PrerequisiteSpawns` 留空
只是不再要求「先单独清完再打 boss」，4 只守卫**仍然全程参战**——run343 五场每场都有它们的
伤害记录（Keeper 288,315 + Tender 160,307）。也就是说队伍面对的目标数量没有减少，
减少的只是框架对「清怪顺序」的编排。反过来说，本轮**曾经**试过真正的隔离形态
（把守卫组彻底避开只打 boss），run343 证明它做不到，见下。
