...
- **乌特加德之巅（2026-09-26）**：Svala 5/5、Gortok 5/5、Ymiron 4/5（playerbots `bef4c908` Bane 停手），Skadi 跳过待确认（BACKLOG 14 鱼叉）。raidtest 新增实例数据夹具/确认、gameobject 与 areatrigger 开战。用户要求连续推进：下一个灵魂洪炉 → 萨隆矿坑（勘测已完成，场景已建）。
