...
| modules/mod-playerbots | **codex/an-trash-cc-shackle** | `32a59e29`（2026-09-13/14 八个提交：施法让路 `0596d3c1`、同层守卫 `f6500091`、牧师去盾 `eb1a9655`、AN 层 `f93314e2`、践踏圣佑+预盾 `b883188c`、追敌不离主坦 `4b02c3ee`、治疗保距 `f54c55f5`、近战躲踏路径 `32a59e29`，叠在 `4215044f` 之上）。**未推 fork** |
